<header class="panel-heading">
    Add {{config('constants.PRODUCTS_CATEGORY')}}
</header>
<div class="panel-body">
    <div class="row">
        <form method="post" role="form" action="{{route('admin.products-category.insert')}}">
            {{csrf_field()}}
            <div class="col-md-12">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control has-feedback-left" id="pro_cat_title"
                               name="pro_cat_title" value="{{ old('pro_cat_title') }}"
                               type="text">
