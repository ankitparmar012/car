...
!function (a) {
    ...
    var n = {ENTER: 13, ESC: 27, F1: 112, F12: 123, LEFT: 37, RIGHT: 39}, o = {
        ...
        var va, wa, xa = [], ya = null, za = a.navigator.userAgent.indexOf("Safari") > -1 && a.navigator.userAgent.indexOf("Chrome") < 0, Aa = {
        ...
        }, Ca = !1, Da = !1, Ea = null, Fa = 0, Ga = 0, Ha = "pageX", Ia = "pageY", Ja = null, Ka = !1, La = null, Ma = null, Na = Number.Nan, Oa = 0, Pa = 0, Qa = 0;
        return {
            __init: m, isOpen: function () {
                ...
                var c = this, d = C(this, this.__internal.options, function (a, b, d) {
                    B(c, a, b, d)
                }, a, b);
                if ("get" === d.op)return d.found ? d.value : "undefined" != typeof this.settings ? C(this, this.settings, this.settingUpdated || function () {
                    }, a, b).value : void 0;
                if ("set" === d.op) {
